...
* **Ensure the bug was not already reported** by searching on GitHub under [Issues](https://github.com/dentiny/duckdb-object-storage/issues).
* If you're unable to find an open issue addressing the problem, [open a new one](https://github.com/dentiny/duckdb-object-storage/issues/new/choose). Be sure to include a **title and clear description**, as much relevant information as possible, and a **code sample** or an **executable test case** demonstrating the expected behavior that is not occurring.
...
/duckdb_build_dir # git clone https://github.com/dentiny/duckdb-object-storage.git && cd duckdb-object-storage
/duckdb_build_dir/duckdb-object-storage # git submodule update --init --recursive
/duckdb_build_dir/duckdb-object-storage # CMAKE_BUILD_PARALLEL_LEVEL=$(nproc) make
```
